...
* An application ID, application secret, and redirect URI values of an application registered in the [Application Registration Portal](https://apps.dev.microsoft.com/). 

     > Note: During the app registration process, make sure to specify **http://127.0.0.1:8000/connect/get_token/** as a redirect URI.

## Configure and run the app

1. Using your favorite IDE, open **config.py** in the *connect* directory.
2. Replace *ENTER_YOUR_CLIENT_ID* with the application ID of the app you registered in the [Application Registration Portal](https://apps.dev.microsoft.com/).
3. Replace *ENTER_YOUR_SECRET* with an application secret generated in the [Application Registration Portal](https://apps.dev.microsoft.com/) of your app.
